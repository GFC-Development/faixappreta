...
const WHATSAPP_LINK = "https://wa.me/5551997736652?text=Ol%C3%A1%2C%20quero%20aproveitar%20a%20promo%C3%A7%C3%A3o%20de%20lan%C3%A7amento%20do%20faixappreta";
    ...
    <div className="flex flex-col">
      ...
      <section id="planos" className="py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-lg mx-auto p-10 rounded-[2.5rem] border border-red-600/30 bg-[#161616] relative shadow-2xl">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-red-600 text-white text-xs font-bold uppercase tracking-widest px-6 py-2 rounded-full whitespace-nowrap shadow-lg shadow-red-600/30">
              Primeiros Parceiros
            </div>
            <div className="text-center mb-8">
              ...
              <div className="flex flex-col items-center">
                <div className="flex items-center justify-center gap-3 mb-2">
                  <span className="text-zinc-500 text-sm font-medium">Preço Regular:</span>
                  <span className="text-zinc-500 text-lg line-through decoration-red-500/50">
                    R$ 179,90
                  </span>
                  <span className="bg-[#a3e635]/10 text-[#a3e635] text-xs font-bold px-2 py-0.5 rounded-md uppercase tracking-wider">
                    [ 45% OFF ]
                  </span>
                </div>
                <div className="flex items-baseline gap-1 mt-1">
                  <span className="text-[#a3e635] text-3xl font-medium">
                    R$
                  </span>
                  <span className="text-white text-8xl md:text-9xl font-teko font-bold leading-none tracking-tight">
                    99,90
                  </span>
                ...
                <div className="inline-flex items-center gap-2 bg-red-600 text-white shadow-[0_0_20px_rgba(220,38,38,0.4)] px-5 py-2.5 rounded-full text-sm font-bold uppercase tracking-widest">
                  ⏳ Lote 1: Encerra dia 03/07 às 23:59
                </div>
              </div>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full py-4 rounded-full bg-red-600 text-white font-bold uppercase tracking-widest hover:bg-red-700 transition-all shadow-lg shadow-red-600/30 text-lg"
            >
              <MessageCircle className="w-5 h-5" />
